  ...
  return (
    <div style={{ maxWidth: 760, margin: "0 auto", padding: "2rem 1.25rem", fontFamily: "inherit" }}>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p>Or write directly to <strong>support@noqx.co.in</strong> with your order ID and Razorpay payment ID (visible in the order receipt).</p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        <h2>11. Contact</h2>
        <p><strong>Support:</strong> support@noqx.co.in</p>
        <p><strong>Grievance Officer (DPDP Act compliance):</strong> grievance@noqx.co.in</p>
